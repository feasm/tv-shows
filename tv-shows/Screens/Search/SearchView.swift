...
struct SearchView<ViewModel: HomeViewModel>: View {
    @ObservedObject var viewModel: ViewModel
    
    var body: some View {
        ZStack {
            LazyVStack(alignment: .leading, spacing: DesignSystemConstants.Spacing.short) {
            ...
            NavigationLink(destination: viewModel.navigateToShowDetailView(id: showViewModel.id)) {
                HStack(spacing: DesignSystemConstants.Spacing.short) {
                    ...
                    VStack(alignment: .leading, spacing: DesignSystemConstants.Spacing.veryShort) {
                        ...
                        ImageText(image: "calendar", text: showViewModel.status)
                    }
                }
